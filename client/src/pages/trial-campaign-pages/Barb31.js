    ...
    return (
        <div id='outer-div'>
            <div id='left-hand-side'>
                ...
                <p className='explaination-box'>
                    Because you're a Barbarian, you are particularly good at hitting people with big weapons. So you take a +4 bonus to your roll.
                </p>
            </div>
            ...
            <div id='right-hand-side'>
                ...
                {diceResult !== null ? `You rolled a ${diceResult}.` : ''}
                    <p>
                            The final result is {diceResult} + 4 = {diceResult +4}.
                    </p>
                </p>

                {processDiceRoll()}

                <Link to={'/barb-page-3-1-1'}>
                    <Button>
                        Continue
                    </Button>
                </Link>
